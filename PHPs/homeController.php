...
// $max_rg = 0;
// $age_category = $_COOKIE["age_category"];
// $maxquery="SELECT username FROM scores where age_category = '$age_category' and event_category='Religious Gathering' order by score desc";
// $resultmax = $conn->query($maxquery);
// $num_rows = $resultmax->num_rows;
...
//     }
//     if(isset($_COOKIE['initial_score']))
//     {
//         $initial_score = $_COOKIE['initial_score'];
//     }
...
//     }
//     }
//     if(isset($_COOKIE['c1']) && $count1 == 1)
//     {
//         if($_COOKIE['c1'] == $a1i)
//         $initial_score = $initial_score + 2;
//     }
//     if(isset($_COOKIE['c2']) && $count2 == 1)
//     {
//         if($_COOKIE['c2'] == $a2i)
//         $initial_score = $initial_score + 2;
//     }
//     if(isset($_COOKIE['c3']) && $count3 == 1)
//     {
//         if($_COOKIE['c3'] == $a3i)
//         $initial_score = $initial_score + 2;
//     }
//     if(isset($_COOKIE['c4']) && $count4 == 1)
//     {
//         if($_COOKIE['c4'] == $a4i)
//         $initial_score = $initial_score + 2;
//     }
